...
namespace Robim.Grasshopper.Commands
{
    [Obsolete]
    public class Custom : GH_Component
    {
        public Custom() : base(" command", "CustomCmd", "Custom command written in the manufacturer specific language", "Robim", "Commands") { }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var command = new Robim.Commands.Custom(name);
    ...
    {
        public CustomCommand() : base("Custom command", "CustomCmd", "Custom command written in the manufacturer specific language", "Robim", "Commands") { }
    ...
    {
        public Group() : base("Group command", "GroupCmd", "Group of commands", "Robim", "Commands") { }
        public override GH_Exposure Exposure => GH_Exposure.primary;
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var command = new Robim.Commands.Group();
    ...
    {
        public SetDO() : base("Set DO", "SetDO", "Set digital output", "Robim", "Commands") { }
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var command = new Robim.Commands.SetDO(DO, value);
            DA.SetData(0, new GH_Command(command));
        }
    }
    ...
    {
        public SetAO() : base("Set AO", "SetAO", "Set analog output", "Robim", "Commands") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var command = new Robim.Commands.SetAO(AO, value);
            DA.SetData(0, new GH_Command(command));
        }
    }
    ...
    {
        public PulseDO() : base("Pulse DO", "PulseDO", "Send a pulse to a digital output", "Robim", "Commands") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var command = new Robim.Commands.PulseDO(DO, length);
            DA.SetData(0, new GH_Command(command));
        }
    }
    ...
    {
        public Wait() : base("Wait", "Wait", "Stops the program for a specific amount of time", "Robim", "Commands") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var command = new Robim.Commands.Wait(time);
            DA.SetData(0, new GH_Command(command));
        }
    }
    ...
    {
        public WaitDI() : base("Wait DI", "WaitDI", "Stops the program until a digital input is turned on", "Robim", "Commands") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var command = new Robim.Commands.WaitDI(DI);
            DA.SetData(0, new GH_Command(command));
        }
    }
    ...
    {
        public Stop() : base("Stop program", "Stop", "Stops the program until an operator starts it again", "Robim", "Commands") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            var command = new Robim.Commands.Stop();
            DA.SetData(0, new GH_Command(command));
        }
    }
    ...
    {
        public Message() : base("Message", "Message", "Sends a text message to the teach pendant", "Robim", "Commands") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;
        ...
        protected override void SolveInstance(IGH_DataAccess DA)
        {
            ...
            var command = new Robim.Commands.Message(message);
            DA.SetData(0, new GH_Command(command));
        }
    }
}