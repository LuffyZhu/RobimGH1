...
using System;
using System.Linq;
using static Robim.PosTransform;
...
namespace Robim.Grasshopper
{
    ...
    {
        public PlaneToMatrix() : base("Plane to matrix", "PToM", "Transform plane to matrix", "Robim", "Util") { }
    ...
    {
        public MatrixToPlane() : base("Matrix to plane", "MToP", "Transform matrix to plane", "Robim", "Util") { }
        public override GH_Exposure Exposure => GH_Exposure.tertiary;
    ...
    {
        public PlaneToQuaternion() : base("Plane to quaternion", "PToQ", "Transform plane to quaternion", "Robim", "Util") { }
    ...
    {
        public QuaternionToPlane() : base("Quaternion to plane", "QToP", "Transform quaternion to plane", "Robim", "Util") { }
    ...
    {
        public PlaneToEuler() : base("Plane to euler", "PToE", "Transform plane to euler", "Robim", "Util") { }
    ...
    {
        public EulerToPlane() : base("Euler to plane", "EToP", "Transform euler to plane", "Robim", "Util") { }
    ...
    {
        public EulerToQuaternion() : base("Euler to quaternion", "EToQ", "Transform euler to quaternion", "Robim", "Util") { }
    ...
    {
        public QuaternionToEuler() : base("Quaternion to euler", "QToE", "Transform quaternion to euler", "Robim", "Util") { }
    ...
    {
        public PlaneToAxisAngle() : base("Plane to axis angle", "PToA", "Transform plane to axis angle", "Robim", "Util") { }
    ...
    {
        public AxisAngleToPlane() : base("Axis angle to plane", "AToP", "Transform axis angle to plane", "Robim", "Util") { }
