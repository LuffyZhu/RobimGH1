...
namespace Robim.Grasshopper
{
    ...
    {
        public ToolpathParameter() : base("Toolpath", "Toolpath", "This is a robot toolpath.", "Robim", "Parameters") { }
        public override GH_Exposure Exposure => GH_Exposure.tertiary;
        protected override System.Drawing.Bitmap Icon => Properties.Resources.iconToolpath;
    ...
    {
        public ProgramParameter() : base("Program parameter", "Program", "This is a robot program", "Robim", "Parameters") { }
        public override GH_Exposure Exposure => GH_Exposure.tertiary;
        protected override System.Drawing.Bitmap Icon => Properties.Resources.iconProgramparameter;
    ...
    {
        public TargetParameter() : base("Target parameter", "Target", "This is a robot target", "Robim", "Parameters") { }
    ...
    {
        public ToolParameter() : base("Tool parameter", "Tool", "This is a robot tool or end effector", "Robim", "Parameters") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;
    ...
    {
        public SpeedParameter() : base("Speed parameter", "Speed", "This is a robot speed", "Robim", "Parameters") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;
    ...
    {
        public ZoneParameter() : base("Zone parameter", "Zone", "This is a robot approximation zone", "Robim", "Parameters") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;
    ...
    {
        public FrameParameter() : base("Frame parameter", "Frame", "This is a robot base frame", "Robim", "Parameters") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;
    ...
    {
        public CommandParameter() : base("Command parameter", "Command", "This is a robot command", "Robim", "Parameters") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;
    ...
    {
        public RobotSystemParameter() : base("RobotSystem parameter", "RobotSystem", "This is a robot RobotSystem", "Robim", "Parameters") { }
    ...
    public class PRparameter : GH_PersistentParam<GH_PR>
    {
        public PRparameter() : base("Processor Register", "PR", "This is a PR", "Robim", "Parameters") { }
        public override GH_Exposure Exposure => GH_Exposure.hidden;
        protected override System.Drawing.Bitmap Icon => Properties.Resources.iconProcessorRegister;
        public override Guid ComponentGuid => new Guid("{BE865FB2-4979-42E2-9429-D8229D4AAA0E}");
        protected override GH_GetterResult Prompt_Singular(ref GH_PR value)
        {
            value = new GH_PR();
            return GH_GetterResult.success;
        }
        protected override GH_GetterResult Prompt_Plural(ref List<GH_PR> values)
        {
            values = new List<GH_PR>();
            return GH_GetterResult.success;
        }
    }

    public class TargetCurveParameter : GH_PersistentParam<GH_TargetCurve>
    {
        public TargetCurveParameter() : base("TargetCurve parameter", "TargetCurve", "This is a target curve", "Robim", "Parameters") { }
        public override GH_Exposure Exposure => GH_Exposure.secondary;

        protected override System.Drawing.Bitmap Icon => Properties.Resources.iconCurveTargetParameter;
        public override Guid ComponentGuid => new Guid("{C4548937-8403-4518-B55A-AF33CF5FE60F}");
        protected override GH_GetterResult Prompt_Singular(ref GH_TargetCurve value)
        {
            value = new GH_TargetCurve();
            return GH_GetterResult.success;
        }
        protected override GH_GetterResult Prompt_Plural(ref List<GH_TargetCurve> values)
        {
            values = new List<GH_TargetCurve>();
            return GH_GetterResult.success;
        }
    }
}
