...
namespace Robim
{
    public class Program
    {
        ...
        public List<CellTarget> Targets { get; internal set; }
        ...
        public List<List<List<string>>> Code { get; set; }
        ...
        /// Workpiece mesh
        /// </summary>
        //public Mesh Workpiece { get; internal set; }
        ...
        public CheckProgram checkProgram { get; internal set; }
        public int StepCount { get; internal set; } = 0;
        ...
        public Program(string name, RobotSystem robotSystem, IEnumerable<IToolpath> toolpaths, Commands.Group initCommands = null, IEnumerable<int> multiFileIndices = null, double stepSize = 1.0)
        {
            ...
            checkProgram = new CheckProgram(this, cellTargets, stepSize);
            this.Targets = cellTargets;
        }
        public void Compute()
        {
            checkProgram.Compute();
            int indexError = checkProgram.indexError;

            //Stop at Error

            //if (indexError != -1) Targets = Targets.GetRange(0, indexError + 1).ToList();
