...
namespace Robim.Commands
{
    ...
    public class CustomToLine : Command
    {
        Dictionary<Manufacturers, string> _customCommands = new Dictionary<Manufacturers, string>();
        Dictionary<Manufacturers, string> _customDeclarations = new Dictionary<Manufacturers, string>();

        public CustomToLine(string name = "Custom command", Manufacturers manufacturer = Manufacturers.All, string command = null, string declaration = null)
        {
            Name = name;
    ...
    public class SetDO : Command
    {
        ...
        protected override void Populate()
        {
            ...
            _commands.Add(Manufacturers.Aubo, CodeAubo);
            _commands.Add(Manufacturers.FANUC, CodeFANUC);
            _commands.Add(Manufacturers.Estun, CodeEstun);

            _declarations.Add(Manufacturers.Estun, DeclarationEstun);
        }
        ...
        string CodeAubo(RobotSystem robotSystem, Target target)
        {
            string textValue = Value ? "True" : "False";
            return $"set_digital_out({robotSystem.IO.DO[DO]},{textValue})";
        }
        ...
        string CodeFANUC(RobotSystem robotSystem, Target target)
        {
            ...
            return $"DO[{robotSystem.IO.DO[DO]}]={textValue};";
        }

        string CodeEstun(RobotSystem robot, Target target)
        {
            string textValue = Value ? "1" : "0";
            return $"SetDO{{IO=t_l.DO{Name.Substring(Name.Length - 3)},Val={textValue}}}";
            //最多999个DO command可以被使用
        }

        string DeclarationEstun(RobotSystem robot)
        {
            string textValue = Value ? "1" : "0";
            return $"DO{Name.Substring(Name.Length-3)}={{_Type=\"DO\",port={DO},value={textValue}}}";
            //最多999个DO command可以被使用
        }
    ...
    public class SetAO : Command
    {
        ...
        protected override void Populate()
        {
            ...
            _declarations.Add(Manufacturers.Aubo, DeclarationAubo);
            //_declarations.Add(Manufacturers.FANUC, DeclarationFANUC);
            //_declarations.Add(Manufacturers.ESTUN, DeclarationEstun);
        ...
        string DeclarationAubo(RobotSystem robotSystem)
        {
            return $"{Name} = {Value:0.###}";
        ...
        string CodeFANUC(RobotSystem robotSystem, Target terget)
        {
            return $"AO[{robotSystem.IO.AO[AO]}]={Value}";
        }
    ...
    public class WaitDI : Command
    {
        ...
        string CodeAubo(RobotSystem robotSystem, Target target)
        {
            ...
            //string indent = "  ";
            string textValue = Value ? "not " : "";
            return $"while {textValue}robot.get_board_io_status(5,{robotSystem.IO.DI[DI]}):sleep(0.008)";
        }
    ...
    public class Stop : Command
    {
        ...
        protected override void Populate()
        {
            ...
            _commands.Add(Manufacturers.Aubo, (_, __) => "stop");
        }
    ...
    public class Message : Command
    {
        ...
        protected override void Populate()
        {
            ...
            _commands.Add(Manufacturers.Aubo, (_, __) => $"textmsg(\"{_message}\")");
            _commands.Add(Manufacturers.FANUC, (_, __) => $"{_message};");
        }
