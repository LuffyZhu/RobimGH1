...
namespace Robim
{
    ...
    {
        internal RobotCellStaubli(string name, List<MechanicalGroup> mechanicalGroups, IO io, Plane basePlane, Mesh environment, RobimFormSystem robimFormSystem) : base(name, Manufacturers.Staubli, mechanicalGroups, io, basePlane, environment, robimFormSystem) { }
...
<Project xmlns=""http://www.staubli.com/robotics/VAL3/Project/3"">
  <Parameters version=""s7.10.2"" stackSize=""1000"" millimeterUnit=""true"" />
  <Programs>
